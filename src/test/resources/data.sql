...
-- 建物データ
INSERT INTO buildings (project_id, building_price, building_address, building_type,
                       building_structure, building_size, building_date, building_remark,
                       is_deleted)
VALUES (1, 5000000, '三条市東三条AP', 'アパート', '木造', 150.32, '1988-06-09', '', false),
       (2, 1000000, '燕市寿町', 'アパート', '木造', 176.91, '1986-06-20', '建物の傾き有り。',
        false),
       (3, 50000, '村上市', '戸建て', '木造', 52.5, '1957-06-13', '', false),
       (4, 500000, '三条市南四日町', '戸建て', '木造', 85.89, '1975-06-11', '', false),
       (5, 26000000, '燕市吉田旭町', 'アパート', '鉄骨造', 265.32, '1994-06-15', '', false),
       (6, 1700000, '長岡市柏町', 'マンション', '鉄筋コンクリート造', 26.12, '1991-01-23', '',
        false),
       (7, 90000000, '三条市東裏館', 'アパート', '木造', 282.98, '2025-10-01', '2LDK×8部屋',
        false),
       (8, 50000000, '三条市', 'マンション', '鉄筋コンクリート造', 1300.0, '1981-01-20',
        '2DK×24部屋', false);
