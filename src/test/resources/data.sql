...
VALUES (1, 1, 10000000, '新潟県三条市', '宅地', 452.65, '', false),
       ...
       (4, 1, 1000000, '三条市南四日町', '宅地', 121.11, '', false),
       (5, 3, 36000000, '燕市吉田旭町', '宅地', 532.11, '', false),
       (6, 2, 0, '長岡市柏町', '宅地', 0.0, '', false),
       (7, 1, 20000000, '三条市東裏館', '田', 672.65, '取得価格の内造成費用1000万円を想定。',
        false),
       (8, 3, 10000000, '三条市', '宅地', 660.0, '', false);
...
VALUES (1, 1, 5000000, 'アパート', '木造', 150.32, '1988-06-09', '', false),
       (2, 1, 1000000, 'アパート', '木造', 176.91, '1986-06-20', '建物の傾き有り。',
        false),
       (3, 2, 50000, '戸建て', '木造', 52.5, '1957-06-13', '', false),
       (4, 1, 500000, '戸建て', '木造', 85.89, '1975-06-11', '', false),
       (5, 3, 26000000, 'アパート', '鉄骨造', 265.32, '1994-06-15', '', false),
       (6, 2, 1700000, 'マンション', '鉄筋コンクリート造', 26.12, '1991-01-23', '',
        false),
       (7, 1, 90000000, 'アパート', '木造', 282.98, '2025-10-01', '2LDK×8部屋',
        false),
       (8, 3, 50000000, 'マンション', '鉄筋コンクリート造', 1300.0, '1981-01-20',
        '2DK×24部屋', false);
...
VALUES (1, 1, 160000, 8000, 0, 0, 85000, 25000, 0, 0, 5000, 0, 5000, '', false),
       (2, 1, 80000, 4000, 0, 0, 40000, 10000, 0, 0, 0, 0, 2000, '', false),
       (3, 2, 30000, 1500, 0, 0, 0, 0, 0, 0, 0, 0, 1000, '', false),
       (4, 1, 50000, 2500, 0, 0, 20000, 7000, 0, 0, 0, 0, 1000, '', false),
       (5, 3, 700000, 14000, 0, 0, 350000, 40000, 0, 0, 5000, 0, 4000, '', false),
       (6, 2, 30000, 1500, 8000, 7000, 0, 0, 0, 0, 0, 0, 800, '', false),
